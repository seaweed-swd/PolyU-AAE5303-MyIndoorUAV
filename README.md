...
- Envs: We use the base env for IndoorUAV+openpi, use conda venv for habitate-sim. A keypoint is habitate-sim should install via conda and I try to compile it then fail. A Tsinghua source speedup for some of the packages is neccesary.
